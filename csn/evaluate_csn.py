...
train_dataset = TripletDataset(
    root_dir="/home/wangx/datasets/polyvore/images/", transform=transform
)
...
def test_fitb_quesitons(test_fitb_dataset, embeddingnet):
    ...
    for i in range(len(test_fitb_dataset)):
        ...
        items, labels, question_part, question_id, options, option_labels = test_fitb_dataset.get_fitb_quesiton(
            i
        )
