...
class TripletDataset(Dataset):
    ...
    def __init__(self,
             root_dir="/export/home/wangx/datasets/polyvore-dataset/images/",
             data_file='train_no_dup_with_category_3more.json',
             data_dir="/export/home/wangx/datasets/polyvore-dataset/polyvore/",
             transform=None,
             is_train=True):
        self.root_dir = root_dir
        self.data_dir = data_dir
...
if __name__ == "__main__":
    ...
    d = CategoryDataset(transform=transform, use_mean_img=True,
                        data_file='/export/home/wangx/datasets/polyvore-dataset/polyvore/train_no_dup_with_category_3more_name.json')
